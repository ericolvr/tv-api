...
class TestComputePredictedAudience:
    ...
    def test_mediana_das_4_ultimas(self):
        ...
        aud = make_audience([
            {"signal": "SP1", "program_code": "HUCK",
             "exhibition_date": "2020-07-04", "average_audience": 1_000_000},
            {"signal": "SP1", "program_code": "HUCK",
             "exhibition_date": "2020-07-11", "average_audience": 2_000_000},
            {"signal": "SP1", "program_code": "HUCK",
             "exhibition_date": "2020-07-18", "average_audience": 3_000_000},
            {"signal": "SP1", "program_code": "HUCK",
             "exhibition_date": "2020-07-25", "average_audience": 4_000_000},
            {"signal": "SP1", "program_code": "HUCK",
             "exhibition_date": "2020-08-01", "average_audience": 5_000_000},
            {"signal": "SP1", "program_code": "HUCK",
             "exhibition_date": "2020-08-08", "average_audience": 6_000_000},
        ])
    ...
    def test_menos_de_4_exibicoes_usa_todas(self):
        ...
        aud = make_audience([
            {"signal": "BH", "program_code": "BIGB",
             "exhibition_date": "2020-07-06", "average_audience": 100_000},
            {"signal": "BH", "program_code": "BIGB",
             "exhibition_date": "2020-07-13", "average_audience": 200_000},
        ])
        result = compute_predicted_audience(aud)
    ...
    def test_uma_exibicao_mediana_e_ela_mesma(self):
        ...
        aud = make_audience([
            {"signal": "RJ", "program_code": "VALE",
             "exhibition_date": "2020-07-08", "average_audience": 500_000},
        ])
        result = compute_predicted_audience(aud)
    ...
    def test_separa_por_dia_da_semana(self):
        ...
        aud = make_audience([
            {"signal": "SP1", "program_code": "PTV1",
             "exhibition_date": "2020-07-06", "average_audience": 1_000_000},
            {"signal": "SP1", "program_code": "PTV1",
             "exhibition_date": "2020-07-07", "average_audience": 9_000_000},
        ])
        result = compute_predicted_audience(aud)
        seg = result[
            (result["signal"] == "SP1") &
    ...
    def test_separa_por_sinal(self):
        ...
        aud = make_audience([
            {"signal": "SP1", "program_code": "HUCK",
             "exhibition_date": "2020-07-04", "average_audience": 2_000_000},
            {"signal": "BH", "program_code": "HUCK",
             "exhibition_date": "2020-07-04", "average_audience": 500_000},
        ])
        result = compute_predicted_audience(aud)
...
class TestBuildProcessed:
    ...
    def test_sem_historico_gera_nulo(self):
        ...
        inventory = make_inventory([
            {"signal": "SP1", "program_code": "NOVO",
             "date": "2020-08-01", "available_time": 300},
        ])
    ...
    def test_join_correto(self):
        ...
        inventory = make_inventory([
            {"signal": "SP1", "program_code": "HUCK",
             "date": "2020-08-01", "available_time": 300},  # sábado=5
        ])
        predicted = pd.DataFrame([
            {"signal": "SP1", "program_code": "HUCK",
             "weekday": 5, "predicted_audience": 1_000_000},
            {"signal": "SP1", "program_code": "HUCK",
             "weekday": 6, "predicted_audience": 9_999_999},
        ])
        result = build_processed(inventory, predicted)
